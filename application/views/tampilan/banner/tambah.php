        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <div class="row mb-2" >
                        <div class="col-6">
                            <h4 class="header-title m-t-0 m-b-20">Banner Tambah</h4>
                        </div>
                    </div>
                    <form action="<?php echo BASEURL.'tampilan/banner/tambahOnAct' ?>" method="POST">
                        <div class="form-group">
                            <label>Title banner</label>
                            <input type="text" class="form-control" name="titleBanner" required>
                        </div>
                        <div class="form-group">
                            <label>Control Target Action(URL)</label>
                            <input type="text" class="form-control" name="urlBanner" required>
                        </div>
                        <div class="form-group">
                            <label>Image Banner</label>
                            <input type="file" class="form-control" name="imgBanner" required>
