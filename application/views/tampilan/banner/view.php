        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <div class="row mb-2" >
                        <div class="col-6">
                            <h4 class="header-title m-t-0 m-b-20">Banner View</h4>
                        </div>
                        <div class="col-6 text-right">
                            <a href="<?php echo BASEURL.'tampilan/banner/tambah' ?>" class="btn btn-info">Tambah</a>
                        </div>
                    </div>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($banner as $key => $it): ?>
                                <tr>
                                    <td><?php echo $it['nama_banner'] ?></td>
                                    <td><?php echo $it['image_banner'] ?></td>
                                    <td><?php echo $it['created_date'] ?></td>
                                    <td>
                                        <a href="<?php echo BASEURL.'tampilan/banner/edit/'.$it['id_banner'] ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <button class="btn btn-danger trash-confirm" data-idtag="<?php echo $it['id_banner'] ?>"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                            ...
                            $.confirm({
                                ...
                                buttons: {
                                    confirm: {
                                        ...
                                        btnClass: 'btn-orange',
                                        action: function(){
                                            return $.post( "<?php echo BASEURL.'tampilan/banner/deletedata' ?>", { id_delete: idprod }).done(function( data ) {
                                                location.reload();
                                              });
