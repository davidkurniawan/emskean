        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <div class="row mb-2" >
                        <div class="col-6">
                            <h4 class="header-title m-t-0 m-b-20">Table Tag Product</h4>
                        </div>
                        <div class="col-6 text-right">
                            <a href="<?php echo BASEURL.'tag/tambah' ?>" class="btn btn-info">Tambah</a>
                        </div>
                    </div>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($tag as $key => $it): ?>
                                <tr>
                                    <td><?php echo $it['tag_product_name'] ?></td>
                                    <td><?php echo $it['created_date'] ?></td>
                                    <td>
                                        <a href="<?php echo BASEURL.'tag/edit/'.$it['tag_product_id'] ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <button class="btn btn-danger trash-confirm" data-idtag="<?php echo $it['tag_product_id'] ?>"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
