        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <div class="col-md-12">
                        <div class="card-box">
                            <div class="button-invoice text-right">
                                <a href="<?php echo BASEURL.'transaksi/orders/invoice/'.$orders['transaction_id'] ?>" class="btn btn-primary">Invoice Detail</a>
                            </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>Provinsi/Kota/Kode Post</td>
                                    <td><?php echo $orders['user_provinsi'].', '.$orders['user_kota'] ?></td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td><?php echo $orders['user_alamat'] ?></td>
                                </tr>
                                <tr>
                                    <td>Catatan</td>
