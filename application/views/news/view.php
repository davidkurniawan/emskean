        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <div class="row mb-2" >
                        <div class="col-6">
                            <h4 class="header-title m-t-0 m-b-20">Table News</h4>
                        </div>
                        <div class="col-6 text-right">
                            <a href="<?php echo BASEURL.'news/tambah' ?>" class="btn btn-info">Tambah News</a>
                        </div>
                    </div>
                            ...
                            $.confirm({
                                ...
                                buttons: {
                                    confirm: {
                                        ...
                                        btnClass: 'btn-orange',
                                        action: function(){
                                            return $.post( "<?php echo BASEURL.'news/deleteItem' ?>", { id_delete: idnews }).done(function( data ) {
                                                location.reload();
                                              });
