        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Claim Referral </h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <div class="row mb-2" >
                        <div class="col-6">
                            <h4 class="header-title m-t-0 m-b-20">Table Claim Referral</h4>
                        </div>
                        ...
                        <tbody>
                            <?php foreach ($item as $key => $kat): ?>
                                <tr>
                                    ...
                                    <td><?php echo $kat['kode_voucher'] ?></td>
                                    <td>IDR <?php echo number_format($kat['value_voucher']) ?></td>
                                    <td>
                                        <a class="btn btn-primary" href="<?php echo BASEURL.'claimreferral/claimAct/'.$kat['id_referral_code_voucher'] ?>">Confirm Acc Claim</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                            <?php foreach ($itemtwo as $key => $kat): ?>
                                <tr>
                                    <td>Terkonfirmasi</td>
                                    <td><?php echo $kat['nama'] ?></td>
                                    <td><?php echo $kat['email'] ?></td>
                                    ...
                                    <td>IDR <?php echo number_format($kat['value_voucher']) ?></td>
                                    <td>
                                        <button type="button" disabled class="btn btn-success">Confirm Acc Claim</button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
