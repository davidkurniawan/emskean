        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    ...
                    <form method="POST" action="<?php echo BASEURL.'productsubkategori/tambahact' ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" name="size"></textarea>
                        </div>
