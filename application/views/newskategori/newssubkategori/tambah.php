    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">News Sub Kategori </h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-box">
                    <h4 class="header-title m-t-0 m-b-20">Form News Sub Kategori</h4>

                    <form method="POST" action="<?php echo BASEURL.'newssubkategori/tambahact' ?>" enctype="multipart/form-data">
