        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">TURN OFF/ON PAYMENT</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="m-t-0 header-title">TABLE TURN OFF/ON PAYMENT</h4>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php foreach ($payment as $key => $prod): ?>
                                <tr>
                                    <td><?php if($prod['status_turn_payment'] == 1){echo "PAYMENT ACTIVE";} else { echo "PAYMENT NOT ACTIVE"; } ?></td> 
                                    <td>
                                    	<form action="<?php echo BASEURL.'turnpayment/updateStatus/'.$prod['id_turn_payment'] ?>" method="post">
	                                    	<div class="input-group form-group	 mb-3">
	                                    		<select class="form-control" name="status" aria-describedby="button-addon2">
	                                    			<option <?php if($prod['status_turn_payment'] == 1){echo "selected='selected'";} ?> value="1">ACTIVE</option>
	                                    			<option <?php if($prod['status_turn_payment'] == 2){echo "selected='selected'";} ?> value="2">NOT ACTIVE</option>
	                                    		</select>
